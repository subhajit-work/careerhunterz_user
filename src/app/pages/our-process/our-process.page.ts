...
@Component({
  ...
  templateUrl: './our-process.page.html',
  styleUrls: ['./our-process.page.scss'],
})

export class OurProcessPage implements OnInit, OnDestroy {
  ...
  commonFunction(){
    ...
    // view page url name
    this.listing_view_url = 'get-process';
