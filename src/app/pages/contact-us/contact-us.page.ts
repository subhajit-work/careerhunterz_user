...
export class ContactUsPage implements OnInit, OnDestroy {
  ...
  //--------------  getlist data fetch start -------------
    ...
    selectLoadingDepend;
    groupList;
    form_submit_text = 'Get A Quote Now';
    form_api;
    ...
    // ------ init function call start ------
      ...
      commonFunction(){
        ...
        // form submit api add
        this.form_api = 'addquery'

        // getservice api
        this.getServiceContact_api = 'core-services';
        this.getService();
    ...
    getService(){
      ...
      this.getServiceSubscribe = this.http.get(this.getServiceContact_api).subscribe(
        (res:any) => {
        this.selectLoadingDepend = false;
        this.coreService =res.return_data.data;
        console.log('sss', res);
      },
      errRes => {
        this.selectLoadingDepend = false;
      ...
      this.formSubmitSubscribe = this.http.post(this.form_api, fd).subscribe(
        (response:any) => {
          ...
          if(response.return_status > 0){
            ...
            this.form_submit_text = 'Get A Quote Now';
